...
export default {
  ...
  methods: {
    ...
    async handleEdit(val) {
      ...
      if (selectedData.query_scope) {
        queryScope.push(selectedData.query_scope.company_code)
        if (selectedData.query_scope.branch_code) {
          queryScope.push(selectedData.query_scope.branch_code)
        }
        if (selectedData.query_scope.member_code) {
          queryScope.push(selectedData.query_scope.member_code)
        }
      }
      this.form.query_scope = queryScope
      // this.form.query_scope = [selectedData.query_scope.company_code,selectedData.query_scope.branch_code,selectedData.query_scope.member_code]
